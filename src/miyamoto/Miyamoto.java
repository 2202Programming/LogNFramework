...
public class Miyamoto extends RobotDefinitionBase {
	...
	public Map<String, IControl> loadControlObjects() {
		...
		MotionProfile[] profiles = { new MotionProfile(0.08, 1), new MotionProfile(0.06, 1), new MotionProfile(0.05,0.6), new MotionProfile(0.01,0.4),new MotionProfile(0.01,0.3) };
